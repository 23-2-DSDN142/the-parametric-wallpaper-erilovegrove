//your parameter variables go here!
  ...
  var seaweedx = 20;
  var seaweedy = 90;
  var seaweed1x = 100; //changes x position of first seaweed //20
  var seaweed1y = 40; //changes y position of first seaweed //40
  var seaweed2x = 100; //changes x position of second seaweed etc. //100
  var seaweed2y = 100; //100
  var seaweed3x = 100; //190
  var seaweed3y = 180 //60
  ...
  var buttfiny = 10; //20
  var topfinleftx = 20; //changes x position of the left point of the triangle //30
  var topfinrightx = 40; //changes x position of the two right points of the triangle //60
  var topfiny = 20; //changes y position of the top point of the fin //20
  var bottomfinleftx = 10; //10
  var bottomfinrightx = 30; //30
  var bottomfindowny = 60; //50
  var bottomfintopy = 30; //20
  var bubblex = 40; //40
  var bubbley = 20; //10
  var bubblesize = 40; //50
